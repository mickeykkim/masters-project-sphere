...
urlpatterns = [
   ...
   re_path(r'^wearabledata/(?P<pk>[\w-]+)/create/$', views.create_wearabledata, name='create_wearabledata'),
   re_path(r'^wearabledata/(?P<pk>[\w-]+)/import/annotation/(?P<path>.*)$', views.import_wearableannotation_csv,
           name='import_wearableannotation_csv'),
]
