...
urlpatterns = [
    ...
    re_path(r'^patientdata/(?P<pk>[\w-]+)/create/wearable/$', views.create_wearabledata, name='create_wearabledata'),
    re_path(r'^patientdata/(?P<pk>[\w-]+)/create/camera/$', views.create_cameradata, name='create_cameradata'),
